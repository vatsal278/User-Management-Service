...
```
### You can test the api using post man, just import the ![Postman Collection](./docs/user management svc.postman_collection.json "Postman Collection") into your postman app.
